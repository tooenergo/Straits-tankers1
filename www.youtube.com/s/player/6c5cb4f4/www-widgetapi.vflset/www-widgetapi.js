(function () {
  ...
  function v(a) {
    ...
    if (typeof a.length == "number") return { next: ia(a) };
  ...
  y.prototype.U = function (a, b) {
    ...
    (b = this.h = this.h || b)
      ? b.O
        ? (this.g = this.l || this.i)
        : b.C != void 0 && this.i < b.C
        ? ((this.g = b.C), (this.h = null))
        : (this.g = this.i)
      : (this.g = a);
  };
  ...
  r("Promise", function (a) {
    ...
    b.prototype.B = function () {
      if (this.g != null) {
        for (var f = 0; f < this.g.length; ++f) h.h(this.g[f]);
        this.g = null;
      }
    };
    var h = new c();
    ...
    b.race = function (f) {
      return new b(function (e, g) {
        for (var l = v(f), m = l.next(); !m.done; m = l.next())
          d(m.value).J(e, g);
      });
    };
    b.all = function (f) {
      ...
      if (m && G(e[0], l))
        for (e = 0; e < m.length; e++) {
          ...
          if ((g !== g && w.key !== w.key) || g === w.key)
            return { id: l, list: m, index: e, entry: w };
        }
    ...
    return a
      ...
      : function (b, c, d) {
          ...
          if (typeof h == "function") {
            ...
            for (h = b.length, f = 0; f < h; f++) k.push(c.call(d, b[f], f));
          return k;
        };
  }); /*
...
*/
  ...
  function ta(a, b) {
    ...
    a.ea = function (d, k, h) {
      for (
        var f = Array(arguments.length - 2), e = 2;
        e < arguments.length;
        e++
      )
        f[e - 2] = arguments[e];
...
*/
  ...
  n.P = function (a, b) {
    ...
    if (c) {
      var d = Array(arguments.length - 1),
        k = arguments.length,
        h;
      for (h = 1; h < k; h++) d[h - 1] = arguments[h];
      if (this.u)
        for (h = 0; h < c.length; h++)
          (k = c[h]), ib(this.g[k + 1], this.g[k + 2], d);
      else {
        this.m++;
        try {
          for (h = 0, k = c.length; h < k && !this.i; h++) {
            var f = c[h];
            ...
            Promise.all(
              b.map(function (d) {
                ...
                return F(function (h) {
                  ...
                  if (h.g != 2)
                    return (
                      (k = h.m), k.state === "prompt" && a.g.push(d), h.H(0)
                    );
                  h.F();
                  h.G();
                });
  ...
  var W = {},
    ...
    sb = {};
  function tb() {
    for (var a = v(rb), b = a.next(); !b.done; b = a.next()) (b = b.value), b();
  }
  function ub(a, b) {
  ...
  function wb(a) {
    return (
      (a.search("cue") === 0 || a.search("load") === 0) && a !== "loadModule"
    );
  }
  function xb(a) {
  ...
  function X(a, b) {
    ...
    if ((a = typeof a === "string" ? c.getElementById(a) : a)) {
      ...
      for (var d = 0; d < b.length; d++)
        b[d].host &&
          (b[d].host = b[d].host.toString().replace("http://", "https://"));
      if (!c) {
        ...
        if (yb.yt_embedsEnableIframeSrcWithIntent) {
          ...
          a: if (((e = e === void 0 ? Ua : e), f instanceof L)) e = f;
            ...
            for (a = 0; a < e.length; ++a)
              if (((c = e[a]), c instanceof Ta && c.Y(f))) {
                e = new L(f);
                break a;
              }
            e = void 0;
          ...
          for (a = 0; a < f.length; a++)
            (b.sandbox.supports && !b.sandbox.supports(f[a])) ||
              b.sandbox.add(f[a]);
          if (e instanceof L)
      ...
      if (window.postMessage) {
        ...
        for (var l in sb) sb.hasOwnProperty(l) && Cb(this, l);
      }
    }
  }
  n = X.prototype;
  ...
  function Db(a, b) {
    a.B[b] || ((a.B[b] = !0), Eb(a, "addEventListener", [b]));
  }
  ...
  function Ab(a) {
    if (
      ...
      (a.length !== 11 || !a.match(/^[a-zA-Z0-9\-_]+$/))
    )
  ...
  function zb(a, b) {
    ...
    window.location.host &&
      (c.origin = window.location.protocol + "//" + window.location.host);
    c.widgetid = a.id;
    window.location.href &&
      va(["debugjs", "debugcss"], function (k) {
        ...
        b: {
          ...
          for (var g = k.length; (e = h.indexOf(k, e)) >= 0 && e < f; ) {
            ...
            if (l == 38 || l == 63)
              if (
                ((l = h.charCodeAt(e + g)), !l || l == 61 || l == 38 || l == 35)
              )
                break b;
            e += g + 1;
          }
  ...
  function Jb(a, b) {
    b = v(b);
    for (var c = b.next(), d = {}; !c.done; d = { v: void 0 }, c = b.next())
      (d.v = c.value),
        a[d.v] ||
          (d.v === "getCurrentTime"
            ? (a[d.v] = function () {
            ...
            ? (a[d.v] = (function (k) {
                return function () {
                  ...
                  return this.playerInfo[
                    h.charAt(f).toLowerCase() + h.substring(f + 1)
                  ];
                };
              })(d))
            : (a[d.v] = (function (k) {
  ...
  function Lb(a) {
    if (a.tagName.toLowerCase() !== "iframe") {
      var b = ub(a, "videoid");
      b &&
        ((b = { videoId: b, width: ub(a, "width"), height: ub(a, "height") }),
        new X(a, b));
    }
  }
  function Gb(a, b, c) {
        ...
        a: if (Kb.has(d.origin)) {
          ...
          if (h && d.origin === h.X)
            switch (
              ((d = h.aa),
              (d.m = !0),
              d.m && (va(d.l, d.sendMessage, d), (d.l.length = 0)),
              (h = k.event),
              (k = k.info),
              h)
            ) {
              case "apiInfoDelivery":
                if (I(k))
                  for (var f in k) k.hasOwnProperty(f) && (d.A[f] = k[f]);
                break;
              case "infoDelivery":
                Ib(d, k);
                break;
  ...
  J("YT.subscribe", function (a, b, c) {
    V.subscribe(a, b, c);
    sb[a] = !0;
    for (var d in W) W.hasOwnProperty(d) && Cb(W[d], a);
  });
  ...
  (typeof YTConfig !== "undefined" &&
    YTConfig.parsetags &&
    YTConfig.parsetags !== "onload") ||
    tb();
  var Nb = H.onYTReady;
  Nb && Nb();
  var Ob = H.onYouTubeIframeAPIReady;
  Ob && Ob();
  var Pb = H.onYouTubePlayerAPIReady;
  Pb && Pb();
}.call(this));
